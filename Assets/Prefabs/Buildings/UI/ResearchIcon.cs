...
public class ResearchIcon : MonoBehaviour,IPointerClickHandler
{
    ...
    public void SetIcon(BuildingGeneric building)
    {
        SelectedBuilding = building;
        Upgrade = building.GetPendingUpgrade();
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        SelectedBuilding.StopUpgrade(Upgrade);
    }
